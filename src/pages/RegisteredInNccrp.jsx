...
import { ArrowCircleLeft, ChevronLeft, Clear, FirstPage, Launch, NewReleases, Pageview, PendingActions, PendingActionsOutlined, QueryStats, SearchTwoTone, Summarize } from '@mui/icons-material';
...
const StyledIcon = styled(Summarize)({
    marginRight: '0.5rem',
    marginTop: '-0.25rem',
                            ...
                            <StyledContainer style={{ minWidth: collapsed ? '84vw' : '', marginLeft: collapsed ? '-40px' : '', transition: '.4s ease' }} className='Bigcontainer' maxWidth="sm">
                                <Box className="Chead" sx={{ textAlign: 'left' }}>
                                    <StyledTypography variant="h4" component="h2">
                                        <StyledIcon /> Registered in NCCRP Complaints <span style={{ fontSize: '10px', color: "green", marginLeft: '5px' }}>
